...
class InfoList extends Component {
	...
	urduList() {
		const { user_id, createdAt, address, lng, lat, id, cnic, phone, UserId } = this.props.itemData;
		...
		return (
			...
			>
				...
				<View style={Styles.memberContainer}>
					{/* delete button */}
					<Button flat text="" onPress={() => this.onDelete({ id, phone, cnic, HouseHoldDetails, address })} icon={<Icon name="trash" size={20} color={Colors.primaryColor} />} />
