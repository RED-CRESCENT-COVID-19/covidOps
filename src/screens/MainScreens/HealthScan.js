...
import { Text, StyleSheet, View, AsyncStorage, ActivityIndicator, Alert } from 'react-native';
	...
	render() {
		...
		return this.props.loading ? (
			...
			<View style={Styles.container}>
				...
				<Text style={[Styles.topParagraph, style]}>{I18n.t(`Paragarphs.HEALTHSCAN`)}</Text>
				...
				<Text style={[screenStyles.titleLabel, style, { paddingRight: 35 }]}>{I18n.t(`Labels.SCANNINGSUMMARY`)}</Text>

				<CalculationLabel value={this.props.houseScanned} secondaryText={I18n.t(`Labels.HOUSEHOLDSCANNED`)} />
				<CalculationLabel value={this.props.personScanned} secondaryText={I18n.t(`Labels.PEOPLESCANNED`)} />
