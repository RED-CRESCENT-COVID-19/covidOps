...
import { Text, StyleSheet, View, AsyncStorage, Keyboard, Alert, KeyboardAvoidingView } from 'react-native';
			...
			<View style={Styles.container}>
				...
				<View style={screenStyles.textInput}>
					...
					<TextField
						...
						onSubmitEditing={() => {
							isUnderAge ? this.thirdTextInput.focus() : this.secondTextInput.focus();
						}}
						// onBlur={() => this.onBlur()}
					/>
				...
				<View style={Styles.genderButtonsContainer}>
					<TextButton
						...
						color={selectedGenderType === 'm' ? Colors.primaryColor : Colors.transparent}
						titleColor={selectedGenderType === 'm' ? Colors.buttonTextColor : Colors.primaryColor}
						shadeBorderRadius={1.5}
						style={[Styles.smallGenderButton, selectedGenderType === 'm' && Styles.smallGenderButtonActive]}
						onPress={(e) => this.genderButtonClick('m')}
					/>
					<TextButton
						title={I18n.t(`Labels.GENDEROPTIONS.FEMALE`)}
						color={selectedGenderType === 'f' ? Colors.primaryColor : Colors.transparent}
						titleColor={selectedGenderType === 'f' ? Colors.buttonTextColor : Colors.primaryColor}
						shadeBorderRadius={1.5}
						style={[Styles.smallGenderButton, selectedGenderType === 'f' && Styles.smallGenderButtonActive]}
						onPress={(e) => this.genderButtonClick('f')}
					/>
					<TextButton
						title={I18n.t(`Labels.GENDEROPTIONS.OTHER`)}
						color={selectedGenderType === 'o' ? Colors.primaryColor : Colors.transparent}
						titleColor={selectedGenderType === 'o' ? Colors.buttonTextColor : Colors.primaryColor}
						shadeBorderRadius={1.5}
						style={[Styles.smallGenderButton, selectedGenderType === 'o' && Styles.smallGenderButtonActive]}
